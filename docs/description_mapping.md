...
| Activities 3 (SFI)      | Otherwise `rTreXu` starts with SFI and `qocAEz` selected (guarded by `isSfiScheme`; ORNEC repeaters empty) | **qocAEz** — "Which SFI action codes involve operations that need Natural England consent (ORNEC)?" (page-20 multi-select)               | Selected action codes joined by `, `                                                                        |
| Fallback                | No scheme and no activities                                                                                | —                                                                                                                                        | Empty                                                                                                       |
