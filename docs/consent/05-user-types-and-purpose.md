...
| Other schemes                                     | `S28E Consent`                   | Optional (via `WtpFqT`)          | Activities under a different permission (e.g. planning permission, other licence)       |
...
| `email_header` field?      | Yes (scheme and/or activities + SSSI names)                       | Yes (scheme and/or activities + SSSI/Euro site names)                            | Yes (detailed_work_type + site names) |
