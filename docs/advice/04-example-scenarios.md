...
```json
{
  ...
  "description": "S28i Advice - Felling of 5 hectares of conifer plantation adjacent to the SSSI boundary - Charnwood Lodge SSSI, Beacon Hill SSSI",
  "consulting_body_type": "Government Agency",
  "consulting_body": "Forestry Commission",
  "customer_name": "John Forester",
  "customer_email_address": "john.forester@forestrycommission.gov.uk",
  "email_header": "S28i Advice - Felling of 5 hectares of conifer plantation adjacent to the SSSI boundary - Charnwood Lodge SSSI, Beacon Hill SSSI",
  "is_contractor_working_for_public_body": "No",
  "public_body_type": "Government Agency",
  "public_body": "Forestry Commission",
...
```json
{
  ...
  "broad_work_type": "Standalone HRA Reg 63",
  "detailed_work_type": "Standalone HRA Reg 63",
  "description": "Standalone HRA Reg 63 - Residential development of 200 units within 400m of the SPA boundary - Arun Valley Ramsar",
  ...
  "email_header": "Standalone HRA Reg 63 - Residential development of 200 units within 400m of the SPA boundary - Arun Valley Ramsar",
  "is_contractor_working_for_public_body": "No",
...
```json
{
  ...
  "broad_work_type": "S28i Advice",
  "detailed_work_type": "S28i Advice",
  "description": "S28i Advice - Flood defence works involving bank reinforcement along 500m of river channel - River Itchen SSSI",
  ...
  "email_header": "S28i Advice - Flood defence works involving bank reinforcement along 500m of river channel - River Itchen SSSI",
...
```json
{
  ...
  "description": "SSSI - Regulation and Enforcement - Unauthorised tree felling observed in the northwest section of the forest near the main footpath - Epping Forest SSSI",
  "consulting_body_type": "Member of public",
  "consulting_body": "Alice Reporter",
  "customer_name": "Alice Reporter",
  "customer_email_address": "alice.reporter@email.com",
  "email_header": "SSSI - Regulation and Enforcement - Unauthorised tree felling observed in the northwest section of the forest near the main footpath - Epping Forest SSSI",
  "is_contractor_working_for_public_body": "No",
  "public_body_type": "Member of public",
  "public_body": "",
  "is_there_a_european_site": "",
