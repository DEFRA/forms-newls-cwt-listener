...
| Priority       | Segment                | Source                                                                                                                                                                                                                                                                                                               |
| -------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 (primary)    | Land management scheme | `rTreXu` — when present, listed first. When `rTreXu = "Other schemes"`, replaced with the answer to `aIixRu` ("What is the name of the land management scheme?"). On the "…or another permission?" branch (no scheme selected), opens with the permission name from `VacBun` ("What is the name of the permission?") |
