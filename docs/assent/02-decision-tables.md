...
| --- | -------------------------------------------------- | ----------------------------- | --------------------- | ------------------ | ------------------------ | -------------------- | -------------------------- | ----------------------------- |
| 1   | A public body                                      | Government agency             | -                     | -                  | -                        | {selected body}      | -                          | Public body: Gov agency       |
| 2   | A public body                                      | Harbour authority             | -                     | -                  | -                        | {selected body}      | -                          | Public body: Harbour          |
| 3   | A public body                                      | Landowner                     | -                     | -                  | -                        | {selected body}      | -                          | Public body: Landowner        |
| 4   | A public body                                      | Land occupier                 | -                     | -                  | -                        | {selected body}      | -                          | Public body: Land occupier    |
| 5   | A public body                                      | Local planning authority      | -                     | -                  | {selected LA}            | -                    | -                          | Public body: LPA              |
| 6   | A public body                                      | Utility provider              | -                     | -                  | -                        | {selected body}      | -                          | Public body: Utility          |
| 7   | A public body                                      | Other                         | -                     | -                  | -                        | -                    | {free text}                | Public body: Other            |
| 8   | A public body                                      | (any except LPA/Other)        | -                     | -                  | -                        | Other                | -                          | Public body: Other via cfPoiN |
| 9   | An organisation working on behalf of a public body | (any except LPA/Other)        | {selected org}        | -                  | -                        | {selected body}      | -                          | Contractor: named org         |
| 10  | An organisation working on behalf of a public body | Local planning authority      | {selected org}        | -                  | {selected LA}            | -                    | -                          | Contractor: named org (LPA)   |
| 11  | An organisation working on behalf of a public body | Other                         | {selected org}        | -                  | -                        | -                    | {free text}                | Contractor: named org (Other) |
| 12  | An organisation working on behalf of a public body | (any except LPA/Other)        | Other                 | {free text}        | -                        | {selected body}      | -                          | Contractor: other org         |
| 13  | An organisation working on behalf of a public body | Local planning authority      | Other                 | {free text}        | {selected LA}            | -                    | -                          | Contractor: other org (LPA)   |
| 14  | An organisation working on behalf of a public body | Other                         | Other                 | {free text}        | -                        | -                    | {free text}                | Contractor: other org (Other) |
